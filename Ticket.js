...
let raton3 = new Raton('Bluetooth', 'Apple');
raton3.marca = 'Apple';
console.log( raton3.toString() );

let teclado1 = new Teclado('Bluetooth', 'MSI');
let teclado2 = new Teclado('USB', 'Acer');
let teclado3 = new Teclado('Bluetooth', 'Apple');
...
let monitor3 = new Monitor('LEDHD', 35);
...
let computadora3 = new Computadora('Apple', monitor2, raton2, teclado2);
